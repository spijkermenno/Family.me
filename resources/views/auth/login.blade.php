        ...
        <div class="container-fluid min-h-100 pt-lg-5 pt-xl-5 pt-md-0 pt-sm-0">
            <div class="text-center mt-3 pt-3">
                ...
                <div id="text" class="title_text">
                    <div class="display-1 mt-5 pt-lg-5 pt-xl-5 pt-md-0 pt-sm-0 text-white bg-primary noselect" id="title">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div id="username" class="form-group py-1">
                                    <div id="labels" class="row px-3 text-light">
                                        ...
                                        <label class="col-6 text-right text-dark p-0">
                                ...
                                <div id="password" class="form-group">
                                    <div id="label" class="text-light">
                                        <label for="password" class="d-block text-left pl-1">
                                            {{trans('auth.password')}}
                                        </label>
                                    </div>
                                    <div id="input">
